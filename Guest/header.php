                    ...
                    <div class="col-12">
                        <div class="top-header-content d-flex align-items-center justify-content-between">
                            ...
                            <div class="top-header-meta d-flex">
                                ...
                                <!-- Cart -->
                                <div class="cart">
                                    <a href="login.php"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <span>Cart <span class="cart-quantity">(1)</span></span></a>
                                </div>
                                &nbsp;
                                &nbsp;
                                <!-- <div class="login">
                                    <a href="../Guest/logout.php"><i class="fas fa-sign-out-alt" aria-hidden="true"></i> <span>Logout</span></a>
                                </div> -->
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="alazeaNav">
                        ...
                        <a href="login.php" class="nav-brand"><img src="img/core-img/4.png" style="margin-left: -10;"></a> <!--logo eco bag-->
